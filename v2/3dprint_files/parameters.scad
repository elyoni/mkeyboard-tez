...
mcu_width = 18;
mcu_length = 33;
mcu_height = 1;  // 4.25 Distance to top of PCB
mcu_row_spacing = 15.24;
mcu_row_count = 2;  // Unused
mcu_pin_count = 24;
mcu_pin_pitch = 2.54; //2.54
mcu_pin_offset = 0;  //0 Offset from the rear of the PCB
mcu_connector_width = 15;  // 13 Width of the connector (for plate cutout)
mcu_connector_length = -2;  //-2, 4 Distance the connector extends onto the MCU (for plate cutout)
mcu_connector_height = 10;  //8 Height of the plug housing
mcu_connector_offset = 1; // Vertical offset of plug center from PCB center
mcu_pcb_thickness = 1.6; //1.6
