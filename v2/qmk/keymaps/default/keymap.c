...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_tez(
            ...
            MO(OTHER),           LT(NUMPAD,KC_SPACE), KC_LSHIFT,           OSL(SYMB),                                                            KC_NO,               LT(SYMB,KC_BSPACE),  LT(MOVE,KC_ENTER),   KC_NO               
            ),
    ...
    [MOVE] = LAYOUT_tez(
            ...
            KC_PRINT_SCREEN,     KC_TRANSPARENT,      KC_TRANSPARENT,      LLOCK,                                                                KC_TRANSPARENT,      KC_TRANSPARENT,      KC_TRANSPARENT,      KC_NO
            ),
    ...
    [OTHER] = LAYOUT_tez(
            ...
            KC_NO,               KC_NO,               KC_NO,               KC_NO,                                                                TG(GAMEM_L),         KC_NO,               KC_NO,               KC_NO 
            ),
